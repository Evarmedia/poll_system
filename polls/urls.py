...
from .views import RegisterView, LoginView, PollListCreateView, PollDetailView, VoteView, PollResultsView, PollDeleteView, PollUpdateView, OptionUpdateView, OptionDeleteView
